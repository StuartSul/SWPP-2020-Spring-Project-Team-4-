...
start matmul 4:
  ...
  .for.cond:
    r1 = load 8 sp 0
    r12 = icmp ult r1 arg1 32
    br r12 .for.cond1.preheader .for.end22
  ...
  .for.cond1:
    r2 = load 8 sp 8
    r13 = icmp ult r2 arg1 32
    store 8 0 sp 16
    store 8 0 sp 24
    br r13 .for.cond4 .for.inc20

  .for.cond4:
    r3 = load 8 sp 16
    r4 = load 8 sp 24
    r14 = icmp ult r3 arg1 32
    br r14 .codeRepl .for.end
