...
entry:
  ...
  %rem = urem i32 %conv, 4
  %conv1 = zext i32 %rem to i64
  call void @assert_eq(i64 %conv1, i64 0)
...
declare dso_local void @assert_eq(i64, i64) #2
...
!1 = !{!"clang version 10.0.1 (https://github.com/llvm/llvm-project.git 060f2f815c4d337f6a1ed9d582a8583b7ed9135e)"}
